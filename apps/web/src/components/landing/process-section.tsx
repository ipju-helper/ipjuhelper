    ...
    <section className="bg-white px-4 py-10">
      <div className="mx-auto w-88.5">
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          <span className="typo-heading-h1 text-[#1F6FEB]">입주 점검 진행 방식</span>
        ...
        <div className="rounded-2xl bg-[#FAFBFA] px-4 py-6">
          <div className="relative mx-auto flex w-58 flex-col gap-15">
            {/* 세로 점선 */}
            <div className="absolute top-0 bottom-0 left-9.75 w-0 border-l border-dashed border-[#E4E7EB]" />
            ...
            {steps.map((step, i) => (
              <div key={i} className="relative flex items-center gap-6">
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-[16px] leading-5.5 font-semibold tracking-[-0.2px] text-[#1E1E1E]">
                    {step.title}
                  </span>
                  <span className="text-[15px] leading-6 font-normal text-[#7B8794]">
                    {step.desc}
                  </span>
                </div>
              </div>
